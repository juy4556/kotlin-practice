...
public class BookController {
    ...
    @org.springframework.web.bind.annotation.PostMapping(value = {"/loan"})
    public void loanBook(@org.jetbrains.annotations.NotNull
    @org.springframework.web.bind.annotation.RequestBody
    com.group.libraryapp.dto.book.request.BookLoanRequest request) {
    }
    
    @org.springframework.web.bind.annotation.PostMapping(value = {"/return"})
    public void returnBook(@org.jetbrains.annotations.NotNull
    @org.springframework.web.bind.annotation.RequestBody
    com.group.libraryapp.dto.book.request.BookReturnRequest request) {
    }
    
    @org.springframework.web.bind.annotation.GetMapping(value = {"/loan"})
    public int countLoanedBook() {
        return 0;
    }
    
    @org.jetbrains.annotations.NotNull
    @org.springframework.web.bind.annotation.GetMapping(value = {"/stat"})
    public java.util.List<com.group.libraryapp.dto.book.response.BookStatResponse> getBookStat() {
        return null;
    }
}